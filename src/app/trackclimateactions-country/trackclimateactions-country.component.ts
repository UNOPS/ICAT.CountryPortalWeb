...
import { AssesmentControllerServiceProxy, AssesmentResaultControllerServiceProxy, Assessment, AssessmentResault, AssessmentYearControllerServiceProxy, Project, ProjectControllerServiceProxy, ServiceProxy, TrackcaEntity, TrackClimateControllerServiceProxy, User } from 'shared/service-proxies/service-proxies';
...
//     console.log('getTrackClimateActionDetails')
//     this.trckCAProxy.getTrackClimateActionDetails().subscribe(res=>{

//       console.log('getTrackClimateActionDetails',res)
...
// });
    ...
    console.log('tokenPayload..,,', this.userRole);
