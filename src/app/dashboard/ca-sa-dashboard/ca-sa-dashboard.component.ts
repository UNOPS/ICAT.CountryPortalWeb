import {HostListener, Component, OnInit, NgModule, OnDestroy } from '@angular/core';
...
export class CASADashboardComponent implements OnInit, OnDestroy {
