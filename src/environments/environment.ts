export const environment = {
  ...
  baseUrlAPIDocUploadAPI: 'https://icat-countryportalservice-qa-2sshj5de3a-ey.a.run.app' + '/document/upload2',
  baseUrlAPIDocUploadAnonymousAPI: 'https://icat-countryportalservice-qa-2sshj5de3a-ey.a.run.app' + '/document/uploadFileAnonymous',
  baseUrlJsonFile:
  ...
  baseUrlExcelUpload: 'https://icat-countryportalservice-qa-2sshj5de3a-ey.a.run.app' + '/parameter/upload',
